      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Learn how to export AI rules from your NPM packages so users can install them with
            vibe-rules.
          </p>
        </div>
        ...
        <section class="mb-12">
          ...
          <div class="feature-card">
            <p class="text-gray-600 dark:text-gray-300 mb-4">
              As AI becomes more integrated into development workflows, reusable AI rules and
              prompts are becoming valuable shared assets. By exporting rules from your NPM
              packages, you can help developers get up to speed with your library's best practices
              quickly.
            </p>
            <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 p-4">
              <p class="text-sm text-blue-700 dark:text-blue-300 dark:text-blue-300">
                vibe-rules looks for an
                <code class="bg-blue-100 dark:bg-blue-800 px-2 py-1 rounded text-xs">llms</code>
                export in your package that contains rule definitions compatible with various
                AI-powered editors.
              </p>
            </div>
          </div>
        ...
        <section class="mb-12">
          ...
          <div class="space-y-6">
            ...
            <div class="feature-card">
              <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-white mb-4">
                1. Configure package.json
              </h3>
              <p class="text-gray-600 dark:text-gray-300 mb-4">
                Add an
                <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-xs">llms</code>
              ...
              <div class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 p-4">
                <p class="text-sm text-yellow-700 dark:text-yellow-300 dark:text-yellow-300">
                  <strong>Note:</strong> You can also use a simple string export:
                  <code class="bg-yellow-100 dark:bg-yellow-800 px-2 py-1 rounded text-xs"
                    >"./llms": "./dist/llms.js"</code
                  >
                </p>
              </div>
            </div>
            ...
            <div class="feature-card">
              ...
              <!-- ESM Example -->
              <div class="mb-6">
                <h4 class="font-semibold text-gray-800 dark:text-gray-200 dark:text-gray-200 mb-2">
                ...
                <div class="code-block">
                  ...
                  <div class="text-green-400 ml-8">
                    rule: "When working with our API, always validate input parameters and handle
                    errors gracefully.",
                  </div>
                  <div class="text-purple-400 ml-8">
                    description: "API development best practices",
                  </div>
                  <div class="text-orange-400 ml-8">alwaysApply: true,</div>
                  <div class="text-cyan-400 ml-8">
                  ...
                  <div class="text-green-400 ml-8">
                    rule: "Write comprehensive tests using our testing utilities. Mock external
                    dependencies.",
                  </div>
                  <div class="text-purple-400 ml-8">
              ...
              <div class="mb-6">
                ...
                <div class="code-block">
                  ...
                  <div class="text-green-400 ml-8">
                    rule: "Use our component composition patterns for building reusable UI
                    elements.",
                  </div>
                  <div class="text-purple-400 ml-8">
          ...
          <div class="feature-card">
            ...
            <div class="code-block mb-4">
              ...
              <div class="text-green-400 ml-4">
                name: string; <span class="text-gray-500">// Rule identifier</span>
              </div>
              <div class="text-green-400 ml-4">
                rule: string; <span class="text-gray-500">// The actual rule content</span>
              </div>
              <div class="text-green-400 ml-4">
                description?: string; <span class="text-gray-500">// Optional description</span>
              </div>
              <div class="text-green-400 ml-4">
                alwaysApply?: boolean;
                <span class="text-gray-500">// Apply automatically (Cursor)</span>
              </div>
              <div class="text-green-400 ml-4">
                globs?: string | string[];
                <span class="text-gray-500">// File patterns to match</span>
              </div>
            ...
            <div class="grid gap-4 mt-6">
              <div class="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">
                  A unique identifier for the rule. Will be prefixed with your package name when
                  installed.
                </p>
              </div>
              ...
              <div class="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">
                  The actual rule content - this is what gets applied to the editor. Can be markdown
                  formatted.
                </p>
              </div>
              ...
              <div class="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">
                  For Cursor editor: when
                  <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs">true</code>,
                  the rule is automatically applied to all files. When
                  <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs">false</code>
              ...
              <div class="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300">
                  File patterns to match. Can be a single string or array of strings. Examples:
                  <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs"
                    >"src/**/*.ts"</code
                  >,
                  <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs"
                    >["**/*.test.js", "**/*.spec.js"]</code
                  >
                </p>
              </div>
            </div>
        ...
        <section class="mb-12">
          ...
          <div class="feature-card">
            <p class="text-gray-600 dark:text-gray-300 mb-4">
              Make sure your build process generates the llms files in the correct format and
              location:
            </p>
            ...
            <div class="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-400 p-4">
              <p class="text-sm text-green-700 dark:text-green-300 dark:text-green-300">
                <strong>Tip:</strong> You can also use a bundler like Rollup or esbuild to generate
                both CommonJS and ESM versions automatically.
              </p>
            </div>
          </div>
        </section>
              ...
              <div class="space-y-3">
                <div class="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-400 p-3">
                  <p class="text-sm text-red-700 dark:text-red-300">
                    <strong>Missing required fields:</strong> Make sure rule objects have
                    <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs">name</code>
                    and
                    <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs">rule</code>
                    properties.
                  </p>
                </div>
                ...
                <div class="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-400 p-3">
                  <p class="text-sm text-red-700 dark:text-red-300">
                    <strong>Wrong export format:</strong> Export should be an array of
                    strings/objects, not a single object.
                  </p>
                </div>

                <div class="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-400 p-3">
                  <p class="text-sm text-red-700 dark:text-red-300">
                    <strong>Invalid globs:</strong> Globs should be strings or arrays of strings,
                    not other types.
                  </p>
                </div>
              </div>
          ...
          <div class="grid gap-4">
            <div class="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-400 p-4">
              ...
              <p class="text-sm text-green-700 dark:text-green-300">
                Use descriptive names like "api-guidelines" or "testing-patterns" rather than
                generic names like "rule1".
              </p>
            </div>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 p-4">
              ...
              <p class="text-sm text-blue-700 dark:text-blue-300">
                Use precise glob patterns to ensure rules only apply to relevant files. Avoid overly
                broad patterns like
                <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs">"**/*"</code>.
              </p>
            </div>
        ...
        <section class="mb-12">
          ...
          <div class="feature-card">
            ...
            <div class="code-block">
              ...
              <div class="text-green-400 ml-8">
                rule: "Always consider performance: use React.memo for expensive components, useMemo
        ...
        <section class="mb-12">
          ...
          <div class="feature-card">
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 p-4 mt-4">
              <p class="text-sm text-blue-700 dark:text-blue-300">
                <strong>Documentation:</strong> Consider adding a section to your README explaining
                that your package exports AI rules that can be installed with vibe-rules.
              </p>
            </div>
          </div>
        </section>
  ...
  meta: [
    {
      name: "description",
      content:
        "Learn how to export AI rules from your NPM packages so users can install them with vibe-rules. Complete guide for library maintainers.",
    },
  ],
});
</script>
